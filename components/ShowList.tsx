...
export default function ShowData(){
    ...
    useEffect(()=>{
        const fetchMenu = async () => {
            try{
                ...
                // using data.reduce for summing up prices
    ...
    const calculateShares = (data: IDataList[]) => {
        // Use data.map... figure out how much rahul, ramesh spent
        // setRahulSpent , setRameshSpent
  ...
  /*  return (<h1>Show data comp</h1>);*/
    ...
    //header... Expense Tracker, headers of the table
